...
- **Modularise at 150 lines**: Split into logical modules
- **Python API imports**: Absolute (`from config import X`)
- **Configuration separate**: `config/` for JSON, env vars for secrets

## Key Files
- `scripts/script_update_live.py`: Fetches RSS, normalises dates
...
✅ API modularisation (config, models, github_sync)
✅ Project refactoring (src/, scripts/, config/, docs/ organisation)
